 ...
 function CrudPage()
{
    ...
    const addFoodData=()=>{
        Axios.post("https://react-mongodb-crud-server.onrender.com/insert",{foodName,description})
        .then((response)=>{
  ...
  //get the data
  const fetchData=()=>{
    Axios.get('https://react-mongodb-crud-server.onrender.com/read').then((response)=>{
  ...
  //update
  const updateFood=(id)=>{
    Axios.put('https://react-mongodb-crud-server.onrender.com/update',{id,newFoodName})
    .then(()=>fetchData())
  }
  ...
  const deleteFood=(id)=>{
    alert("Delete")
    Axios.delete(`https://react-mongodb-crud-server.onrender.com/delete/${id}`).then(()=>fetchData())
  }
    return(
